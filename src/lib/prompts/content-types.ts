...
About 75% of buyers contacted only one agent before choosing one. Source: NAR 2024 Profile of Home Buyers and Sellers. Permitted number: 75. Permitted phrasing: "75% of buyers contact only one agent before hiring", "the typical buyer interviews just one agent".
...
G. NAR 2024 Member Profile — typical agent income
The median REALTOR® earned about $55,000 in gross commission income last year. Half of all REALTORS® earn less than this. Source: NAR 2024 Member Profile. Permitted number: 55 (with unit "k" → renders as "55k") or "$55" (with unit "k"). Permitted phrasing: "the median agent earned about $55K last year", "half of agents earn under $55K a year".

H. NAR 2024 Profile of Home Buyers and Sellers — sellers shopping for an agent
About 73% of sellers interviewed only one agent before listing. Source: NAR 2024 Profile of Home Buyers and Sellers. Permitted number: 73. Permitted phrasing: "73% of sellers interview only one agent", "most sellers list with the first agent they meet". Companion stat to entry C; never use both in the same batch.

I. NAR 2024 Profile of Home Buyers and Sellers — buyers' agent-selection method
The single most common way buyers find their agent is a referral from a friend, family member, or neighbor — about 40% of buyers select their agent this way, and another ~12% use the same agent they hired before. Source: NAR 2024 Profile of Home Buyers and Sellers. Permitted number: 40. Permitted phrasing: "40% of buyers pick their agent from a friend's referral", "most homebuyers pick the agent a friend used".

J. NAR 2024 Profile of Home Buyers and Sellers — used-again INTENT vs REALITY gap
89% of buyers say they would use their agent again (entry D), but only about 12% of buyers actually use the same agent they used in a prior transaction. The gap is the story: satisfaction in the moment doesn't translate into repeat hires. Source: NAR 2024 Profile of Home Buyers and Sellers. Permitted number: 12. Permitted phrasing: "only 12% of buyers actually re-hire their agent", "89% say they would use their agent again — only 12% actually do".

K. NAR 2024 Profile of Home Buyers and Sellers — FSBO price gap
For-sale-by-owner homes sold for a median of $310,000 in 2023, vs $405,000 for agent-assisted sales — a gap of about $95K. (Numbers vary year to year; this is the cleanest cited gap.) Source: NAR 2024 Profile of Home Buyers and Sellers. Permitted number: "$95" (with unit "k" → renders as "$95k"). Permitted phrasing: "the median FSBO home sold for nearly $95K less than agent-assisted in 2023". Do NOT quote dollar amounts beyond the gap; never promise a buyer a specific price outcome.

L. NAR REALTORS® Confidence Index — contract fall-through rate
Roughly 5–7% of pending home sales fall apart before closing in any given month. Source: NAR REALTORS® Confidence Index, monthly. Permitted number: 7. Permitted phrasing: "1 in 15 home sales fall apart before closing", "7% of contracts terminate before closing — usually for reasons a good agent would have caught".

How to use the data above for stat callouts: pick ONE number per post. Put the bare number in the 'number' field (e.g., "10", "40", "89", "80", "55", "73", "12", "$95", "7"), the suffix in the 'unit' field ("%", "+", "k", or empty), and a one-line meaning in the 'statement' field that explicitly ties the stat to the value of choosing a vetted agent (e.g., "of agents close fewer than 10 deals a year — yours should not be one of them"). Always credit the source generically (e.g., "NAR Member Profile, 2024" or "NAR Profile of Home Buyers and Sellers, 2024" or "NAR REALTORS® Confidence Index") in the source field.`,
    angles: [
      ...
      { key: "stat_median_volume", brief: "Use the NAR median (10 transaction sides per year, entry A) to underscore that most agents are low-volume — and why a top performer is a different tier. Source: NAR Member Profile, 2024.", headlineHint: "Most Agents Close 10 a Year" },
      { key: "stat_median_income", brief: "Use the NAR median agent income (~$55K in gross commissions, entry G) to underscore that the median agent is barely making a living from real estate — implying low transaction volume and limited expertise. Frame as: the right match is a top performer, not the median. Source: NAR Member Profile, 2024.", headlineHint: "Median Agent Earns $55K" },
      { key: "stat_newer_agents", brief: "Use the NAR figure that ~40% of agents have 5 years or less experience (entry B). Frame as: a vetted match avoids learning on your dime.", headlineHint: "40% Are New Agents" },
      { key: "stat_no_downturn", brief: "PIVOT of entry B (40% have ≤5 years): most agents licensed today have never sold a home during a buyer's market or rising-rate environment — the post-2008 era was almost entirely seller's-market territory. Frame as: experience navigating a tough market is signal, not noise. Use number 40 (with unit '%') and tie the statement to market-condition experience.", headlineHint: "Most Never Worked a Downturn" },
      { key: "stat_buyer_one_interview", brief: "Use the NAR figure that 75% of buyers contacted only one agent before hiring (entry C). Frame as: most buyers don't shop — getting matched to a top performer up front avoids the regret of picking the first one. Source: NAR Profile of Home Buyers and Sellers, 2024.", headlineHint: "75% Contact Just One" },
      { key: "stat_seller_one_interview", brief: "Use the NAR figure that 73% of sellers interviewed only one agent before listing (entry H). Frame as: most sellers don't comparison-shop on the biggest financial decision of their life — we make the match for you. Companion to stat_buyer_one_interview; do not pair both in one batch.", headlineHint: "73% Interview Just One" },
      { key: "stat_referral_default", brief: "Use the NAR figure that ~40% of buyers pick their agent from a friend's referral (entry I). Frame as: that's how most people pick a dentist, not a top-tier specialist for the biggest purchase of their life. Source: NAR Profile of Home Buyers and Sellers, 2024.", headlineHint: "40% Pick by Referral" },
      { key: "stat_would_use_again", brief: "Use the NAR figure that 89% of buyers would use their agent again (entry D). Frame as: when the match is right, buyers stick with that agent for life — start with the right one.", headlineHint: "89% Would Use Again" },
      { key: "stat_repeat_gap", brief: "Use the gap between intent and reality (entry J): 89% say they'd re-hire their agent, but only 12% actually do. Frame as: in-the-moment satisfaction doesn't translate into repeat business — most buyers move on quietly, suggesting fit was good but not great. Use number 12 (with unit '%'). Source: NAR Profile of Home Buyers and Sellers, 2024.", headlineHint: "Only 12% Re-Hire" },
      { key: "stat_attrition", brief: "Use the industry figure that roughly 8 in 10 new agents leave the business within 5 years (entry E). Frame as: experience and longevity are signal, not noise — our top 10% have proven staying power.", headlineHint: "8 in 10 Agents Quit" },
      { key: "stat_top_10_concentration", brief: "Use the production-concentration data (entry F) — the top 10% of agents close the majority of deals in their market. Frame as: that's exactly the cohort we match you to.", headlineHint: "Top 10% Closes Most Deals" },
      { key: "stat_fsbo_gap", brief: "Use the NAR FSBO vs agent-assisted price gap (entry K): the median FSBO sold for ~$95K less than the median agent-assisted sale in 2023. Frame as: a good agent's value shows up in the price you walk away with. Use number '$95' with unit 'k'. CAVEAT in the statement that the gap reflects a 2023 NAR comparison and pin the year. Source: NAR Profile of Home Buyers and Sellers, 2024.", headlineHint: "FSBO Sold $95K Less" },
      { key: "stat_fall_through", brief: "Use the contract fall-through rate (entry L): roughly 7% of pending sales — about 1 in 15 — terminate before closing. Frame as: a good agent catches the issues that derail a deal before contract. Use number 7 (with unit '%'). Source: NAR REALTORS® Confidence Index.", headlineHint: "1 in 15 Deals Fall Apart" },
    ],
  },
