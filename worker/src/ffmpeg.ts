...
// (Funny Commercial compose removed when the flow pivoted to Story
// Builder. Story exports are Premiere XML zips — Premiere on the
// user's machine handles the concat / mix / overlay work that this
// function used to do server-side.)
